      ...
      try {
        ...
        if (axios.isAxiosError(error)) {
          ...
          if (axiosError.response) {
            ...
            dispatch(
              setTransactionProcessError(error.message || 'Maaf, sedang terjadi kesalahan')
            );
          }
        } else {
          dispatch(
...
const handleGetTransactionProcessData =
...
export { handleGetTransactionProcessData, handleGetTransactionProcessDetailData, handleGetTransactionProcessLogDetailData };
