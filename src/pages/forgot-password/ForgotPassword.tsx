            ...
            <div className="mx-auto bg-white p-6 xl:rounded-xl w-full sm:max-w-[500px] my-auto h-screen sm:h-full">
                <main className="flex flex-col">
                    <header className="flex flex-col items-center mb-10">
                        ...
                        />
                        <h2 className="mb-2 mt-4 text-lg font-bold text-black">Lupa Password</h2>
                        <p className="text-center text-gray-500 text-sm">
                            Masukkan email/no.whatsapp yang <br /> terhubung dengan akun, supaya
                            sistem <br /> mengirim instruksi password baru.
                        </p>
                    </header>
