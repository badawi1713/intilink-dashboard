        ...
        <>
            {
                openAside && <>
                    ...
                    <aside ref={asideRef} className='absolute z-20 xl:relative px-10 py-16 bg-white shadow-lg w-full max-w-xs border min-h-screen h-full '>
                        <img alt='intilink-logo' src={`${window.location.origin}/assets/images/img-logo.png`} className='w-32 h-16 mb-8' />
